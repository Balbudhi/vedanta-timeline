...
[suspicious] gaudapada-sankhya.json (Sāṅkhya commentator) and gaudapada.json (Advaita) — must verify the corpus distinguishes these two figures cleanly. The Sāṅkhya Gauḍapāda (the *Bhāṣya* on the *Sāṅkhya-Kārikā*) is a different person from the Advaita Gauḍapāda (the *Māṇḍūkya-Kārikā*); some 19th-c. scholarship conflated them. Did not have time to inspect both files in full.
