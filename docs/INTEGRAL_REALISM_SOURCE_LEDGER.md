...
| Satchidanandendra Saraswati | `data/thinkers/satchidanandendra.json` exists. Private `parishishta` now holds APK Sanskrit image scans for *Mūlāvidyānirāsaḥ / Śrī Śaṅkara Hṛdayam*, *Pañcapādikā-Prasthānam*, and *Mūlāvidyā Bhāṣya-Vārttika-Viruddhā*, plus Jñānānandendra's *Bhāmatīsamālocanam*. | No raw corpus in public repo. Treat APK PDFs as controlled open access, not public domain; use private extraction notes and public metadata unless rights are cleared. |
