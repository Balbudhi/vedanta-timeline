...
| Satchidanandendra Saraswati | `data/thinkers/satchidanandendra.json` exists. Public repo now holds a DLI scan of *Mūlāvidyānirāsaḥ / Śrī Śaṅkara Hṛdaya*. Private `parishishta` also holds APK Sanskrit image scans for *Mūlāvidyānirāsaḥ / Śrī Śaṅkara Hṛdayam*, *Pañcapādikā-Prasthānam*, and *Mūlāvidyā Bhāṣya-Vārttika-Viruddhā*, plus Jñānānandendra's *Bhāmatīsamālocanam*. | APK PDFs remain controlled open access, not public domain; use private extraction notes and public metadata unless rights are cleared. |
...
| Benedikt Paul Göcke and Swami Medhananda, eds., *Panentheism in Indian and Western Thought* | Listed under `materials/medhananda/`; verify chapter-level relevance before relying on it. |
...
| P0 | Satchidanandendra, *The Method of the Vedanta* / related APK texts | Public DLI scan held for *Mūlāvidyānirāsaḥ / Śrī Śaṅkara Hṛdaya*; APK scans for the mūlāvidyā/Bhāmatī cluster are held privately; *The Method of the Vedanta* itself still needs a specific source decision if cited. | Private extraction notes or public metadata after rights check. | Needed for `adhyāsa`, mūlāvidyā criticism, and the ill-posed locus/origin question for avidyā. |
