...
| **brahman** | mixed | All Vedānta shares *brahman* as *jagat-kāraṇa* and Upaniṣadic purport. AF1 real disagreement on *nirviśeṣa* vs. *saviśeṣa*. Sāṅkhya's gloss as *avyakta* flagged as different concept. Buddhists have functional analogues only. |
...
| **prakṛti** | mixed | Sāṅkhya's *svatantra* claim vs. Vedānta's *brahman-śakti* / *aṃśa* — real disagreement (AF1). |
| **puruṣa** | mixed | Witness-structure shared. AF1 real disagreement on plurality (Sāṅkhya/Yoga: many; Advaita: one). |
| **guṇa** | **different_concepts** | Genuinely homonymous *śabda*: (a) Sāṅkhya cosmological *guṇa*-triad, (b) Vaiśeṣika categorial *guṇa* as *padārtha*, (c) Vaiṣṇava *ananta-kalyāṇa-guṇa*. Three distinct *artha*; methodology §4. |
