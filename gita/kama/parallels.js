...
window.GITA3_PARALLELS = {
  ...
  // 3.37 — "This is kāma, this is anger — arisen from the guṇa rajas,
  //         the great devourer, the great evildoer. Know it here to be
  //         the enemy."
  "3.37": [
    {
      ...
      words: [
        {
          ...
          parts: [
            { form: "avidyā", gloss: "ignorance, not-knowing — the misapprehension of the transient, impure, painful and not-self as the eternal, pure, pleasant and self" },
            { form: "asmitā", gloss: "I-am-ness, egoity — the sense of identity between the seer and the instrument of seeing" },
            { form: "rāga", gloss: "attraction, the coloring that follows on pleasure" },
            { form: "dveṣa", gloss: "aversion, the recoil that follows on pain" },
            { form: "abhiniveśa", gloss: "clinging to life, the instinctive will to go on being" }
          ],
          ...
          compound: { type: "dvandva (itaretara)", vigraha: "avidyā ca asmitā ca rāgaś ca dveṣaś ca abhiniveśaś ca", members: ["avidyā", "asmitā", "rāga", "dveṣa", "abhiniveśa"] },
          translatable: true
        },
        {
          i: 1,
          ...
          parts: [
            { form: "√kliś", gloss: "to torment, to trouble, to afflict" },
            { form: "-a", gloss: "(ghañ, the action-noun: 'the afflicting')" }
          ],
          stem: "kleśa",
      ...
      words: [
        {
          ...
          parts: [
            { form: "sukha", gloss: "pleasure, ease, happiness" },
            { form: "anu-√śī", gloss: "to lie down after, to lie latent in the wake of" },
            { form: "-in", gloss: "(taddhita ini: 'the one who —')" }
          ],
          stem: "sukha-anuśayin",
          ...
          compound: { type: "tatpuruṣa (upapada)", vigraha: "sukham anuśete yaḥ saḥ", members: ["sukha", "anuśayin"] },
          translatable: true
        },
        {
          i: 1,
          ...
          parts: [
            { form: "√rañj", gloss: "to be dyed, to be colored, to be attached" },
            { form: "-a", gloss: "(ghañ, the action-noun: 'the coloring')" }
          ],
          stem: "rāga",
        ...
        },
        {
          ...
          parts: [
            { form: "duḥkha", gloss: "pain, suffering, sorrow" },
            { form: "anu-√śī", gloss: "to lie down after, to lie latent in the wake of" },
            { form: "-in", gloss: "(taddhita ini: 'the one who —')" }
          ],
          ...
          compound: { type: "tatpuruṣa (upapada)", vigraha: "duḥkham anuśete yaḥ saḥ", members: ["duḥkha", "anuśayin"] },
          glossaryKey: "duhkha",
          translatable: true
        },
        {
          ...
          parts: [
            { form: "√dviṣ", gloss: "to hate, to be hostile toward" },
            { form: "-a", gloss: "(ghañ, the action-noun: 'the recoiling')" }
          ],
          stem: "dveṣa",
      ...
      words: [
        {
          ...
          parts: [
            { form: "sat", gloss: "being, existing (present participle of √as)" },
            { form: "-tva", gloss: "(taddhita tva: abstract noun, 'the state of being')" }
          ],
          stem: "sattva",
        ...
        },
        {
          ...
          iast: "laghu",
          gloss: "light, buoyant",
          parts: [{ form: "laghu", gloss: "light, buoyant, quick" }],
          stem: "laghu",
          root: null,
        ...
        },
        {
          ...
          parts: [
            ...
            { form: "√kāś", gloss: "to shine, to become manifest" },
            { form: "-aka", gloss: "(ṇvul, agentive: 'that which makes —')" }
          ],
          stem: "prakāśaka",
        ...
        },
        {
          ...
          parts: [
            { form: "√iṣ", gloss: "to wish; (in this idiom) to hold, to deem" },
            { form: "-ta", gloss: "(kta, past passive participle: 'held to be —')" }
          ],
          stem: "iṣṭa",
        ...
        },
        {
          ...
          parts: [
            { form: "upa-", gloss: "toward, up" },
            { form: "√stambh", gloss: "to prop up, to make firm; to incite" },
            { form: "-aka", gloss: "(ṇvul, agentive: 'that which —')" }
          ],
          stem: "upaṣṭambhaka",
        ...
        },
        {
          ...
          parts: [
            { form: "√cal", gloss: "to move, to stir, to shake" },
            { form: "-a", gloss: "(kṛt ac, adjectival: 'moving')" }
          ],
          stem: "cala",
        ...
        },
        {
          ...
          iast: "ca",
          gloss: "and",
          parts: [{ form: "ca", gloss: "and (enclitic)" }],
          stem: null,
          root: null,
          affix: null,
        ...
        },
        {
          ...
          parts: [
            { form: "√rañj", gloss: "to be colored, to be excited, to be stirred" },
            { form: "-as", gloss: "(asun, the neuter noun ending)" }
          ],
          stem: "rajas",
        ...
        },
        {
          ...
          iast: "guru",
          gloss: "heavy",
          parts: [{ form: "guru", gloss: "heavy, weighty" }],
          stem: "guru",
          root: null,
          affix: "su (prathamā ekavacana)",
          morph: "nom. sg. neut.",
        ...
        },
        {
          ...
          parts: [
            { form: "√vṛ", gloss: "to cover, to obstruct, to veil" },
            { form: "-aṇaka", gloss: "(ṇvul, agentive: 'that which —')" }
          ],
          stem: "varaṇaka",
        ...
        },
        {
          ...
          iast: "eva",
          gloss: "alone, indeed",
          parts: [{ form: "eva", gloss: "indeed, alone (restrictive)" }],
          stem: null,
          root: null,
          affix: null,
        ...
        },
        {
          ...
          parts: [
            { form: "√tam", gloss: "to become faint, to lose energy, to be stupefied" },
            { form: "-as", gloss: "(asun, the neuter noun ending)" }
          ],
          stem: "tamas",
        ...
        },
        {
          ...
          parts: [
            { form: "pra-", gloss: "forth, fully" },
            { form: "√dīp", gloss: "to blaze, to flame, to shine" },
            { form: "-a", gloss: "(the noun-forming vowel: 'the blazing thing, the lamp')" },
            { form: "-vat", gloss: "(taddhita vati: 'like, in the manner of')" }
          ],
          stem: "pradīpa-vat",
        ...
        },
        {
          ...
          parts: [
            { form: "artha", gloss: "purpose, aim, meaning" },
            { form: "-tas", gloss: "(taddhita tasil: 'with respect to —')" }
          ],
          stem: "artha",
          root: null,
        ...
        },
        {
          ...
          parts: [
            { form: "√vṛt", gloss: "to turn, to occur, to operate, to function" },
            { form: "-ti", gloss: "(ktin, feminine action-noun: 'the functioning')" }
          ],
          stem: "vṛtti",
  ...
  // 3.39 — "Knowledge is covered by this perpetual enemy of the knower,
  //         whose form is kāma — hard to fill and never having enough."
  "3.39": [
    {
      school: "Jainism",
      ...
      words: [
        {
          ...
          parts: [
            { form: "bhava", gloss: "becoming, worldly existence, continued existence in saṃsāra" },
            { form: "taṇhā", gloss: "craving, thirst (Skt tṛṣṇā)" }
          ],
          stem: "bhava-taṇhā",
          ...
          compound: { type: "tatpuruṣa (ṣaṣṭhī)", vigraha: "bhavassa taṇhā (Skt: bhavasya tṛṣṇā)", members: ["bhava", "taṇhā"] },
          glossaryKey: "trsna",
          translatable: true
        },
        {
          ...
          parts: [{ form: "layā", gloss: "creeper, vine (Skt latā)" }],
          stem: "layā",
          root: null,
        ...
        },
        {
          ...
          parts: [
            ...
            { form: "-tā", gloss: "(past passive participle; Skt uktā)" }
          ],
          stem: null,
        ...
        },
        {
          ...
          parts: [
            { form: "√bhī", gloss: "to fear, to be afraid" },
            { form: "-ma", gloss: "(kṛt: 'fearsome, terrible')" }
          ],
          stem: "bhīma",
        ...
        },
        {
          ...
          parts: [
            { form: "bhīma", gloss: "fearsome, terrible" },
            { form: "phala", gloss: "fruit, result" },
            { form: "ud-√i", gloss: "to arise, to come forth" },
          ...
          morph: "Prakrit nom. sg. fem.",
          karaka: "attribute of layā",
          compound: { type: "bahuvrīhi", vigraha: "bhīmaḥ phalasya udayo yasyāḥ sā (Skt: bhīmaḥ phalodayo yasyāḥ sā)", members: ["bhīma", "phala", "udaya"] },
          translatable: true
        },
        {
          i: 5,
          ...
          parts: [{ form: "ta", gloss: "that (Skt tad)" }],
          stem: "ta",
          root: null,
        ...
        },
        {
          ...
          parts: [
            { form: "ud-", gloss: "up, out" },
            { form: "√dhṛ", gloss: "to hold; (with ud-) to lift up, to pull out, to uproot" },
            { form: "-iccā", gloss: "(absolutive: 'having —ed'; Skt -tvā/-ṛtya)" }
          ],
          stem: null,
        ...
        },
        {
          ...
          parts: [
            { form: "jahā", gloss: "as, in the manner that (Skt yathā)" },
            { form: "nāya", gloss: "known (Skt jñāta, past participle of √jñā)" }
          ],
          stem: "jahā-nāya",
        ...
        },
        {
          ...
          parts: [
            { form: "vi-", gloss: "about, around" },
            { form: "√hṛ", gloss: "to carry; (with vi-) to move about, to fare" },
            { form: "-āmi", gloss: "(1st person singular present)" }
          ],
          stem: null,
        ...
        },
        {
          ...
          parts: [
            { form: "jahā", gloss: "as, in the manner that (Skt yathā)" },
            { form: "suha", gloss: "ease, happiness, pleasure (Skt sukha)" }
          ],
          stem: "jahā-suha",
          root: null,
  ...
  // 3.41 — "Therefore you, having reined in the indriyas at the outset,
  //         O bull of the Bharatas — cast off this evil one, the
  //         destroyer of knowledge and of discernment."
  "3.41": [
    {
      school: "Jainism",
      thinker: "Uttarādhyayana",
      ...
      words: [
        {
          ...
          parts: [
            { form: "√rakkh", gloss: "to guard, to protect, to keep watch over, to hold in check" },
            { form: "-ijja", gloss: "(optative, 3rd singular: 'let him —')" }
          ],
          stem: null,
        ...
        },
        {
          ...
          gloss: "anger",
          parts: [
            { form: "√kroh", gloss: "to be angry, to grow wroth" },
            { form: "-a", gloss: "(the action-noun ending: 'the being-angry')" }
          ],
          stem: "koha",
        ...
        },
        {
          ...
          parts: [
            { form: "vi-", gloss: "away, apart" },
            { form: "√nī", gloss: "to lead; (with vi-) to lead away, to discipline away" },
            { form: "-ejja", gloss: "(optative, 3rd singular: 'let him —')" }
          ],
          stem: null,
        ...
        },
        {
          ...
          gloss: "pride",
          parts: [
            { form: "√man", gloss: "to think; to esteem oneself, to be proud" },
            { form: "-a", gloss: "(the action-noun ending: 'the esteeming-oneself, pride')" }
          ],
          stem: "māṇa",
        ...
        },
        {
          ...
          iast: "māyaṃ",
          gloss: "deceit",
          parts: [{ form: "māyā", gloss: "deceit, guile, illusion-making" }],
          stem: "māyā",
          root: null,
        ...
        },
        {
          ...
          parts: [
            { form: "√sev", gloss: "to resort to, to practise, to cultivate" },
            { form: "-e", gloss: "(optative, 3rd singular: 'let him —')" }
          ],
          stem: null,
        ...
        },
        {
          ...
          parts: [
            { form: "pa-", gloss: "forth, away (Skt pra-)" },
            { form: "√hā", gloss: "to leave, to abandon, to let go, to cast off" },
            { form: "-ejja", gloss: "(optative, 3rd singular: 'let him —')" }
          ],
          stem: null,
        ...
        },
        {
          ...
          gloss: "greed",
          parts: [
            { form: "√lubh", gloss: "to covet, to desire greedily" },
            { form: "-a", gloss: "(the action-noun ending: 'the coveting, greed')" }
          ],
          stem: "loha",
  ...
  // 3.42 — "Higher than the indriyas, they say, is manas; higher than
  //         manas is buddhi; and he who is beyond buddhi — he."
  "3.42": [
    {
      ...
      words: [
        {
          ...
          iast: "ātmānam",
          gloss: "the self",
          parts: [{ form: "ātman", gloss: "the self, oneself" }],
          stem: "ātman",
          root: null,
        ...
        },
        {
          ...
          gloss: "know!",
          parts: [
            { form: "√vid", gloss: "to know, to understand" },
            { form: "-dhi", gloss: "(hi, 2nd singular imperative)" }
          ],
          stem: null,
        ...
        },
        {
          ...
          iast: "ratham",
          gloss: "the chariot",
          parts: [{ form: "ratha", gloss: "chariot" }],
          stem: "ratha",
          root: null,
          affix: "am (dvitīyā ekavacana)",
          morph: "acc. sg. masc.",
        ...
        },
        {
          ...
          iast: "eva",
          gloss: "indeed, surely",
          parts: [{ form: "eva", gloss: "indeed, precisely (restrictive)" }],
          stem: null,
          root: null,
          affix: null,
          morph: "indeclinable restrictive particle",
        ...
        },
        {
          ...
          iast: "tu",
          gloss: "but, now",
          parts: [{ form: "tu", gloss: "but, now, however" }],
          stem: null,
          root: null,
          affix: null,
        ...
        },
        {
          ...
          gloss: "buddhi",
          parts: [
            { form: "√budh", gloss: "to wake, to understand" },
            { form: "-ti", gloss: "(ktin, feminine action-noun)" }
          ],
          stem: "buddhi",
        ...
        },
        {
          ...
          iast: "tu",
          gloss: "but",
          parts: [{ form: "tu", gloss: "but, however" }],
          stem: null,
          root: null,
          affix: null,
          morph: "indeclinable adversative particle",
        ...
        },
        {
          ...
          parts: [{ form: "sa-rathi", gloss: "one who goes with the chariot, the charioteer" }],
          stem: "sārathi",
          root: null,
          affix: "am (dvitīyā ekavacana)",
          morph: "acc. sg. masc.",
        ...
        },
        {
          ...
          gloss: "manas",
          parts: [
            { form: "√man", gloss: "to think" },
            { form: "-as", gloss: "(asun, neuter noun ending)" }
          ],
          stem: "manas",
        ...
        },
        {
          ...
          parts: [
            ...
            { form: "√grah", gloss: "to seize, to grasp, to hold" },
            { form: "-a", gloss: "(the instrument-noun ending: 'that which grips')" }
          ],
          stem: "pragraha",
        ...
        },
        {
          ...
          iast: "eva",
          gloss: "indeed",
          parts: [{ form: "eva", gloss: "indeed (restrictive)" }],
          stem: null,
          root: null,
          affix: null,
          morph: "indeclinable restrictive particle",
      ...
      words: [
        {
          ...
          gloss: "the indriyas",
          parts: [
            { form: "indra", gloss: "Indra, the ruling power" },
            { form: "-iya", gloss: "(taddhita: 'belonging to Indra')" }
          ],
          stem: "indriya",
          root: null,
        ...
        },
        {
          ...
          gloss: "they call",
          parts: [
            { form: "āha-", gloss: "(the substitute stem prescribed for √brū in this ending)" },
        ...
        },
        {
          ...
          gloss: "the objects",
          parts: [
            { form: "vi-", gloss: "apart, across" },
            { form: "√si", gloss: "to bind; the range a faculty covers" },
            { form: "-aya", gloss: "(the derivational ending: 'the domain')" }
          ],
          stem: "viṣaya",
          root: null,
          affix: "as (dvitīyā bahuvacana)",
        ...
        },
        {
          ...
          parts: [{ form: "tad", gloss: "that (anaphoric)" }],
          stem: "tad",
          root: null,
        ...
        },
        {
          ...
          parts: [
            { form: "go", gloss: "cow; (here, by extension) the ranging faculty" },
            { form: "√car", gloss: "to move, to range, to graze" },
            { form: "-a", gloss: "(agent-noun ending: 'what is ranged over')" }
          ],
          stem: "gocara",
          ...
          compound: { type: "tatpuruṣa", vigraha: "goḥ (indriyasya) caraḥ", members: ["go", "cara"] },
          translatable: true
        },
        {
          i: 6,
          ...
          parts: [
            { form: "ātman", gloss: "the self" },
            { form: "indriya", gloss: "the senses" },
            { form: "manas", gloss: "the mind" },
            { form: "√yuj", gloss: "to join, to yoke" },
            { form: "-ta", gloss: "(kta, past passive participle: 'joined')" }
          ],
          ...
          compound: { type: "tatpuruṣa (with a dvandva first member)", vigraha: "ātmā ca indriyāṇi ca manaś ca — tair yuktam", members: ["ātman", "indriya", "manas", "yukta"] },
          translatable: true
        },
        {
          i: 7,
          ...
          parts: [
            { form: "√bhuj", gloss: "to enjoy, to experience, to undergo" },
            { form: "-tṛ", gloss: "(tṛc, agentive: 'the one who —')" }
          ],
          stem: "bhoktṛ",
        ...
        },
        {
          ...
          parts: [{ form: "iti", gloss: "thus, so (quotative)" }],
          stem: null,
          root: null,
          affix: null,
        ...
        },
        {
          ...
          parts: [
            { form: "manīṣā", gloss: "reflection, wise consideration" },
            { form: "-in", gloss: "(taddhita ini: 'the one who has —')" }
          ],
          stem: "manīṣin",
          root: "√man (divādi, 4Ā, 'to think')",
      ...
      words: [
        {
          ...
          parts: [
            { form: "indriya", gloss: "the powers of sense and action" },
            { form: "-bhyaḥ", gloss: "(ablative plural: 'than')" }
          ],
          stem: "indriya",
          root: null,
        ...
        },
        {
          ...
          iast: "parāḥ",
          gloss: "higher",
          parts: [{ form: "para", gloss: "higher, further, beyond" }],
          stem: "para",
          root: null,
        ...
        },
        {
          ...
          iast: "hi",
          gloss: "surely, indeed",
          parts: [{ form: "hi", gloss: "for, surely, indeed" }],
          stem: null,
          root: null,
          affix: null,
        ...
        },
        {
          ...
          gloss: "the objects",
          parts: [
            { form: "√arth", gloss: "to seek, to aim at, to desire" },
            { form: "-a", gloss: "(the object-noun ending: 'the aimed-at thing, the object')" }
          ],
          stem: "artha",
        ...
        },
        {
          ...
          parts: [
            { form: "artha", gloss: "the object" },
            { form: "-ebhyaḥ", gloss: "(ablative plural: 'than')" }
          ],
          stem: "artha",
          root: null,
          affix: "bhyas (pañcamī bahuvacana)",
        ...
        },
        {
          ...
          parts: [
            { form: "√man", gloss: "to think" },
            { form: "-as", gloss: "(asun, neuter noun ending)" },
            { form: "-aḥ", gloss: "(ablative singular: 'than')" }
          ],
          stem: "manas",
          root: "√man (divādi, 4Ā, 'to think')",
        ...
        },
        {
          ...
          gloss: "higher",
          parts: [
            { form: "para", gloss: "higher, further, beyond" },
            { form: "-ā", gloss: "(feminine ending, agreeing with buddhi)" }
          ],
          stem: "para",
          root: null,
        ...
        },
        {
          ...
          parts: [
            { form: "√budh", gloss: "to wake, to understand" },
            { form: "-ti", gloss: "(ktin, feminine action-noun)" },
            { form: "-eḥ", gloss: "(ablative singular: 'than')" }
          ],
          stem: "buddhi",
          root: "√budh (bhvādi, 1U, 'to wake, to understand')",
          affix: "as (pañcamī ekavacana)",
        ...
        },
        {
          ...
          parts: [{ form: "ātman", gloss: "the self" }],
          stem: "ātman",
          root: null,
          affix: "su (prathamā ekavacana)",
          morph: "nom. sg. masc.",
        ...
        },
        {
          ...
          iast: "mahān",
          gloss: "the great (one)",
          parts: [{ form: "mahat", gloss: "great, vast" }],
          stem: "mahat",
          root: null,
          affix: "su (prathamā ekavacana)",
          morph: "nom. sg. masc.",
  ...
  // 3.43 — "Thus, having known what is higher than buddhi, having
  //         steadied the self by the self — slay the enemy, O
  //         mighty-armed one, whose form is kāma, hard to get at."
  "3.43": [
    {
      school: "Jainism",
      thinker: "Uttarādhyayana",
      ...
      words: [
        {
          ...
          parts: [
            { form: "ega", gloss: "one, single, alone (Skt eka)" },
            { form: "appā", gloss: "self, soul (Skt ātman)" }
          ],
          stem: "ega-appā",
          root: null,
          ...
          karaka: "kartṛ of the implied copula",
          compound: { type: "karmadhāraya", vigraha: "ekaś cāsāv ātmā ca (Skt: eka ātmā)", members: ["ega", "appā"] },
          translatable: true
        },
        {
          i: 1,
          ...
          gloss: "unconquered",
          parts: [
            { form: "a-", gloss: "not (negative prefix)" },
            { form: "√ji", gloss: "to conquer, to win, to overcome" },
            { form: "-ya", gloss: "(past passive participle; Skt -ta)" }
          ],
          stem: "ajiya",
        ...
        },
        {
          ...
          gloss: "the enemy",
          parts: [
            { form: "√sad", gloss: "to fall, to perish" },
            { form: "-tru", gloss: "(uṇādi affix: 'the one who makes another fall')" }
          ],
          stem: "sattu",
        ...
        },
        {
          ...
          iast: "kasāyā",
          gloss: "the passions",
          parts: [{ form: "kasāya", gloss: "the passions — anger, pride, deceit and greed (Skt kaṣāya, lit. 'tint, dye, astringent taste')" }],
          stem: "kasāya",
          root: null,
        ...
        },
        {
          ...
          iast: "indiyāṇi",
          gloss: "the senses",
          parts: [{ form: "indiya", gloss: "the powers of sense and action (Skt indriya)" }],
          stem: "indiya",
          root: null,
        ...
        },
        {
          ...
          iast: "ya",
          gloss: "and",
          parts: [{ form: "ya", gloss: "and (Skt ca)" }],
          stem: null,
          root: null,
          affix: null,
        ...
        },
        {
          ...
          parts: [
            { form: "√ji", gloss: "to conquer, to overcome" },
            { form: "-ittu", gloss: "(absolutive: 'having —ed')" }
          ],
          stem: null,
          root: "√ji (Prakrit; Skt √ji, bhvādi, 1P, 'to conquer')",
        ...
        },
        {
          ...
          iast: "ahaṃ",
          gloss: "I",
          parts: [{ form: "ahaṃ", gloss: "I (Skt aham)" }],
          stem: "ahaṃ",
          root: null,
          affix: null,
        ...
        },
        {
          ...
          iast: "muṇī",
          gloss: "sage",
          parts: [{ form: "muṇi", gloss: "sage, silent ascetic (Skt muni)" }],
          stem: "muṇi",
          root: null,
