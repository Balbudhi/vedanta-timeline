...
window.GITA_VERSES = [
  ...
  },
  {
    ...
    "english": "{2:Of a man} {0:dwelling on} {1:the objects}, {3:saṅga} {4:to them} {5:is born}; {6:from saṅga} {8:kāma} {7:is born}; {9:from kāma} {10:anger} {11:arises}.",
    "words": [
      {
        "i": 0,
        "deva": "ध्यायतः",
  ...
  },
  {
    ...
    "sense": "Kṛṣṇa completes the descent: from anger comes delusion; from delusion, confusion of memory; from the ruin of memory, the destruction of the buddhi (the discerning intellect); and from the destruction of the buddhi, the man perishes.",
