...
- the effective phase-0 inputs present on disk were `internal/primitives_revision/audit.md`, `internal/primitives_revision/ai_tell_catalog.md`, and `internal/primitives_revision/COMPLETION_REPORT.md`
...
- used the exact-string tell inventory already present in `internal/primitives_revision/ai_tell_catalog.md` as the measurable baseline
