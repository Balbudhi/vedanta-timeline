...
Runner: [baseline_audit.py](mobile_audit/baseline_audit.py)
...
Primary evidence:
- Before issue references: `philosophy_articles/mobile_audit/screenshots/<viewport>/before-*`
- After issue references: `philosophy_articles/mobile_audit/screenshots/<viewport>/after-*`
- Full latest pass: `philosophy_articles/mobile_audit/screenshots/<viewport>/{timeline_*,topbar_*,thinker_sankara,glossary_popover,citation_popover,article_*,source_tab,network_view}.png`

## Files Changed
- [assets/style.css](assets/style.css)
- [assets/app.js](assets/app.js)
- [mobile_audit/ISSUES.md](mobile_audit/ISSUES.md)
- [mobile_audit/REPORT.md](mobile_audit/REPORT.md)
