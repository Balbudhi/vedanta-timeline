...
Before screenshot: `philosophy_articles/mobile_audit/screenshots/iphone-se/before-topbar-filter.png`
After screenshot: `philosophy_articles/mobile_audit/screenshots/iphone-se/after-topbar-filter.png`
...
Before screenshot: `philosophy_articles/mobile_audit/screenshots/iphone-se/before-thinker-portal.png`
After screenshot: `philosophy_articles/mobile_audit/screenshots/iphone-se/after-thinker-portal.png`
...
Before screenshot: `philosophy_articles/mobile_audit/screenshots/iphone-se/before-glossary-popover.png`
After screenshot: `philosophy_articles/mobile_audit/screenshots/iphone-se/after-glossary-popover.png`
...
Before screenshot: `philosophy_articles/mobile_audit/screenshots/iphone-se/before-citation-popover.png`
After screenshot: `philosophy_articles/mobile_audit/screenshots/iphone-se/after-citation-popover.png`
...
Before screenshot: `philosophy_articles/mobile_audit/screenshots/iphone-se/before-article-primitive-graph.png`
After screenshot: `philosophy_articles/mobile_audit/screenshots/iphone-se/after-article-long-lists.png`
...
Before screenshot: `philosophy_articles/mobile_audit/screenshots/iphone-se/before-article-ramanuja-table.png`
After screenshot: `philosophy_articles/mobile_audit/screenshots/iphone-se/after-article-ramanuja-table.png`
...
Before screenshot: `philosophy_articles/mobile_audit/screenshots/iphone-se/before-source-view.png`
After screenshot: `philosophy_articles/mobile_audit/screenshots/iphone-se/after-source-tab.png`
...
Viewport: `iphone-se` (`375×667`)
Flow: `network_view`
Before screenshot: `philosophy_articles/mobile_audit/screenshots/iphone-se/before-network-view.png`
After screenshot: `philosophy_articles/mobile_audit/screenshots/iphone-se/after-network-view.png`
...
Screenshot paths: current audit outputs under `philosophy_articles/mobile_audit/screenshots/<viewport>/`
