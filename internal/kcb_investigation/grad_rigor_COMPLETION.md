...
Primary acquisitions and canonical working witnesses were consolidated under `ocr/acquired_primaries/`.
...
- `ocr/acquired_primaries/MANIFEST.md`

## Reading Notes Summary

Quotation-grade notes were compiled in:

- `ocr/acquired_primaries/READING_NOTES.md`
...
- `data/articles/source/kcb-kantian-perspectivism.md`
