# Madhva and Advaita: Difference, Dependence, and the Witness

## The question

Madhva’s objection to Advaita is not exhausted by the proposition that an
embodied person is not Viṣṇu. His central claim is stronger: even the liberated
*jīva* remains a real, dependent, conscious being whose essential nature is
distinct from the independent Lord. Advaita, by contrast, holds that the
localized knower and the field of name and form have no being apart from
Brahman. The dispute is therefore about the final status of difference, not
about whether a finite ego can be made divine.

The primary texts establish a genuine contradiction. Madhva does not teach two
independent principles, nor does Śaṅkara teach that the empirical ego is
Brahman. But Madhva makes jīva–Īśvara difference beginningless and final;
Śaṅkara makes plurality non-other than its cause and ultimately sublatable as
independent reality. A synthesis can use both descriptions only by explicitly
assigning them different registers. It cannot be Madhva’s own conclusion.
...
distinction between jīva and Lord, not a contrast internal to one individual
...
reality, then calls this distinction *viśeṣa* and says that it exists in all
things. In Tattvavāda, *viśeṣa* is not a conventional predicate and not an
independent attribute added to a substance. It is a real self-differentiating
determination: what lets a thing be intelligibly this rather than that without
being broken into separable parts. Madhva uses it especially to account for the
...
non-duality; if it does not, the teaching is *siddha-sādhana*, an attempt to
prove what is already proved. The Advaitin answer is that the “self” in the
identity statement is not a separately real jīva but Brahman, while the jīva
...
Madhva does not equate Advaitic *mithyā* with simple nonexistence. His
*Prapañca-mithyātvānumāna-khaṇḍana* states the Advaitin’s inference from
perceivedness to *mithyātva* and disputes it in technical Nyāya terms. In the
*Anuvyākhyāna* he challenges the claim that sublation establishes the
non-being of its prior object. A sublated object must first be available to
...
practice and knowledge. *Bheda-grāhaka* means “apprehending difference.” Thus
Madhva’s argument is not simply: “difference is ordinarily perceived.” It is:
the witness required to discriminate truth and error also knows difference;
...
argument from ontological dependence to identity: he makes dependence itself
...
Madhva accepts *aparokṣa* (immediate) realization of Viṣṇu through devotion
and contemplation. He does not infer from this that knower and Lord become
numerically one. His account of liberation preserves the dependence and
difference of the liberated jīva. Direct realization is therefore not a shared
...
and denies it final status in *sat-svabhāva*. Madhva makes the pure jīva-witness
...
Śaṅkara does not say that an independently real individual is Viṣṇu. In
...
non-difference claimed here. Conversely, Madhva’s inference from
difference-cognition to final difference depends on the premise that such
cognition is never sublated as independent reality—the premise Śaṅkara denies.

## 7. The historical dialectic

Madhva’s successors developed this conflict as a sustained technical debate.
Jayatīrtha systematized Tattvavāda arguments in the *Nyāyasudhā*. One recurring
issue is whether a *mithyā* means of knowledge can establish any conclusion.
The text records Madhva’s dilemma: if the means of knowledge is real, difference
is already established; if it is not, it cannot establish non-difference. The
...
important: it is a polemic against post-Śaṅkara theories of *mithyātva*,
*avidyā*, and inference, not a direct substitute for every statement in
Śaṅkara’s commentaries. Madhusūdana Sarasvatī’s *Advaita-siddhi* replies on the
same logical terrain, defending Advaita’s account of indeterminacy, sublation,
and the scope of *pramāṇas*. Later Tattvavādin commentaries continued the
critique, while Advaitins such as Balabhadra and Brahmānanda replied to it.

The historical sequence shows that neither tradition took the disagreement to
...
Madhva gives a serious refutation of any view that calls the final, individual
knower identical in essential nature with Viṣṇu. His target includes the
liberated witness; his own system preserves difference, devotion, and
dependence in liberation. He is not refuting only the claim that a finite ego
is God.

Śaṅkara and Ramaṇa reject the premise that the individualized witness is final.
For them, the jīva’s distinction belongs to appearance, cognition, or adjunct;
the Self’s non-otherness is not a relation between two independently fixed
entities. Madhva explicitly rejects that account and gives a rival reading of
non-difference texts. The primary evidence therefore establishes a direct
philosophical disagreement, while also establishing a shared rejection of two
independent ultimates. Any modern harmonization must preserve both facts.
